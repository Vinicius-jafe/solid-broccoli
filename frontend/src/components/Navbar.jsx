        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex items-center space-x-3">
            <div className="flex items-center">
              ...
              <svg className="w-8 h-8 text-[#C85A8E] ml-1" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="text-sm text-gray-600">
              ...
              <span className="block">& viagens</span>
            </div>
          </Link>
            ...
            {links.map((link) => (
              <Link
                ...
                className={`text-base font-medium transition-colors duration-200 ${
                  isActive(link.path)
                    ? 'text-[#C85A8E]'
                    : 'text-gray-700 hover:text-[#C85A8E]'
                }`}
              >
                {link.name}
              </Link>
          ...
          <button
            ...
            className="md:hidden text-gray-700 hover:text-[#C85A8E] transition-colors"
          >
            ...
            {links.map((link) => (
              <Link
                ...
                className={`block px-3 py-2 rounded-md text-base font-medium transition-colors ${
                  isActive(link.path)
                    ? 'bg-[#C85A8E] text-white'
                    : 'text-gray-700 hover:bg-pink-50 hover:text-[#C85A8E]'
                }`}
              >
                {link.name}
              </Link>
